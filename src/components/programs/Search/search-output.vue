    ...
    <div style="border: 0px solid #505050; width: 100%;">
        ...
        <table id="searchTrades" style="width: 100%;">
            <tr>
                ...
                <th :id="'legs-'+namespace" style="text-align: center; vertical-align: bottom; background-color: darkblue;"> 
                    <span v-if="source !== 'spread'">
                ...
                <th :id="'width-'+namespace" style="text-align: center; vertical-align: bottom; background-color: darkblue;">
                ...
                <th :id="'position-options-'+namespace" style="text-align: left; vertical-align: bottom; background-color: darkblue;">
                    <b-form-radio-group
                        v-model="position"
                ...
                <th :id="'dates-and-trade-length'+this.namespace" style="text-align: center; vertical-align: bottom; background-color: #9A7D0A">
            ...
            <th style="text-align: center; vertical-align: bottom; background-color: #9A7D0A; width: auto">
                    ...
                    trade length (in days)  <span v-show="tradePeriodExcludedSelector !== 'tradeLength'"></span>
            ...
            <th :id="'percent-profitable-'+namespace" style="text-align: center; vertical-align: bottom" v-bind:style="{backgroundColor: sortParameter == 'percentProfitable' ? 'blue' : 'teal' }">
            ...
            <th style="text-align: center; vertical-align: bottom" v-bind:style="{backgroundColor: sortParameter == 'appd' ? 'blue' : 'teal' }">                    
                <div @click=sort style="white-space: nowrap">
                    <i :id="'appd-'+namespace" class="fas fa-sort"></i>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            rsi() {
                let rsi = this.userConditions.find(x => x.parameter === 'rsi');
                console.log("rsi=", rsi);
            ...
            commodity: {
                ...
                set(commodity) {
                    console.log("commodity.set() starting. this.commodity=", this.commodity);
                            ...
                            .then(apiResponse => {
                                ...
                                let result = temp.map(function (el, index) {
                                    ...
                                    if (spread !== null) {
                                        ...
                                        let tickerLegs = o.spread.replace(/\s/g, '').split(/(?=[-+\s])/);
