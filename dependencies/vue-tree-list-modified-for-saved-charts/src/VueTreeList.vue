  ...
  <div class="vtl">
    ...
    >
      ...
      >
        ...
        <div class="vtl-operation" v-show="isHover">
          ...
          <span :title="defaultUpdateName" @click.stop.prevent="updateChart" v-if="model.isLeaf">
            <slot name="updateNodeIcon" :expanded="expanded" :model="model" :root="rootNode">
              <i class="vtl-icon vtl-icon-edit"></i>
            </slot>
          </span>
    ...
    >
      <item
        ...
        :default-update-name="defaultUpdateName"
      ...
      >
        ...
        <template v-slot:updateNodeIcon="slotProps">
          <slot name="updateNodeIcon" v-bind="slotProps" /> 
        </template>
...
export default {
  ...
  methods: {
    updateChart(e){
       console.log('updateChart() starting. e=', e);
       this.rootNode.$emit('update', this.model);
    },
    updateName(e) {
    ...
    setEditable(e) {
     // console.log('setEditable() starting. e=', e);
      this.editable = true
    ...
    setUnEditable(e) {
      //console.log('setUnEditable() starting.');
      this.editable = false
      //console.log('this.editable=', this.editable);
      var oldName = this.model.name
      this.model.changeName(e.target.value)
    ...
    click() {
    //  console.log('click() starting. this=', this);
    //  console.log('this.editable=', this.editable);
